  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        ...
        <Button className="bg-primary-color hover:bg-blue-600 transition-all font-bold">
          Add hotel
        </Button>
      </div>
      <div className="px-6 py-6 bg-white gap-6 rounded-md shadow-md mt-4 flex">
        ...
        <div className="">
          <p className="font-bold text-gray-700 text-sm mb-2">Accomodations</p>
          <ComboBox
            value={accomodations}
      ...
      <div className="mt-4 bg-white py-4 shadow-md rounded-lg">
        ...
        <div className=" bg-gray-50 flex px-4 border-b-[1px] border-t-[1px]">
          ...
          >
            <p className="text-sm font-bold text-gray-600 ">Accomodations</p>
            {accSort !== 0 && (
              <FontAwesomeIcon
        ...
        {hotels.length > 0 &&
          hotels.map((hotel, idx) => {
            return (
              <div key={idx} className=" bg-white flex px-4 border-b-[1px]">
