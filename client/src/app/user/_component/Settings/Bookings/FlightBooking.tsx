      ...
      {billFlights.length === 0 && (
        <div className="px-4 py-4 flex gap-8 mt-2 border-[1px] rounded-md">
          ...
          <div className="">
            ...
            <p className="">
              Could not find a result for the filter you selected. Reset filters
      ...
      {billFlights.length > 0 && (
        <div className="mt-2">
          {billFlights.map((el, idx) => {
            return (
              <div key={idx} className=" py-4 bg-white rounded-md shadow-md">
                ...
                <div className="flex px-4 pt-2 mt-2 justify-between items-center">
                  ...
                  <p className="font-bold text-primary-color hover:text-blue-600 cursor-pointer transition-all">
                    See detail
                  </p>
                </div>
              </div>
