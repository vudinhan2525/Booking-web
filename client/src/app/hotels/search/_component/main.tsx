...
export default function MainSearchHotelPages() {
  ...
  return (
    <div className=" bg-[#F7F9FA] h-[2000px] border-t-[1px] flex gap-8 px-16 py-10">
      ...
      <div className="basis-[73%]">
        ...
        <div className="mt-4 flex gap-4 p-3 cursor-pointer hover:border-[1px] hover:border-primary-color border-[1px] border-transparent bg-white rounded-lg shadow-md">
          <div className="basis-[35%]">
            <div className="w-full relative h-[140px]">
              <Image
                ...
                src="https://shopcartimg2.blob.core.windows.net/shopcartctn/hotelres.webp"
              />
            </div>
          ...
          <div className="basis-[65%] flex">
            <div className="basis-[70%]">
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <p className="text-sm text-gray-700">Đà Nẵng, Việt Nam</p>
              </div>
            ...
            <div className="basis-[30%] border-l-[1px]">
              <div className="flex flex-col items-end">
                ...
                <p className="text-xs text-gray-500">Included tax & fees</p>
